...
import { ILifeExpectancyItem, } from '../port/in/FinanceUseCases.tsa'
export default class LifeExpectancyModel {
    ...
    // async uploadFiles() {
    //     const dataset: INdcLifeExpectancyRawItem[] = import('./8bef5427a12789acdf8c0411131d9221_export.json')
